# 🔬 LLM Observability & Tracing Studio
> Scaffold self-hosted LLM tracing collectors. Generate Langfuse services deployments, PyOpenTelemetry instrumentation, and trace spans.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/llm-tracing/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/llm-tracing/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-llm-tracing.git
cd tp-llm-tracing
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/llm-tracing/) |
